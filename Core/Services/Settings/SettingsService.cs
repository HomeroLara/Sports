...
namespace Sports.Core.Services
{
    public class SettingsService: ISettingsService
    {
        ...
        private const string IdDataProviderBase = "url_marketing";
        ...
        public string DataProviderEndpointBase
        {
            get => GetValueOrDefault(IdDataProviderBase, UrlDataProviderEndpointBaseDefault);
            set => AddOrUpdateValue(IdDataProviderBase, value);
        }
